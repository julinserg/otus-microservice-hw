...
import (
	...
	users_internalhttp "github.com/julinserg/julinserg/OtusMicroserviceHomeWork/hw05_auth/internal/users/server/http"
	users_sqlstorage "github.com/julinserg/julinserg/OtusMicroserviceHomeWork/hw05_auth/internal/users/storage/sql"
)
...
func main() {
	...
	var storage users_app.Storage
	{
		sqlstor := users_sqlstorage.New()
	...
	serverHttp := users_internalhttp.NewServer(logg, storage, endpointHttp)
