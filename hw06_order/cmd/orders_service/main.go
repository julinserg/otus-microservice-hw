...
import (
	...
	"github.com/julinserg/julinserg/OtusMicroserviceHomeWork/hw06_order/internal/logger"
	orders_app "github.com/julinserg/julinserg/OtusMicroserviceHomeWork/hw06_order/internal/orders/app"
	orders_internalhttp "github.com/julinserg/julinserg/OtusMicroserviceHomeWork/hw06_order/internal/orders/server/http"
	orders_sqlstorage "github.com/julinserg/julinserg/OtusMicroserviceHomeWork/hw06_order/internal/orders/storage/sql"
)

var configFile string

func init() {
	flag.StringVar(&configFile, "config", "./configs/orders_config.toml", "Path to configuration file")
}
...
func main() {
	...
	f, err := os.OpenFile("orders_service_logfile", os.O_RDWR|os.O_CREATE|os.O_APPEND, 0o666)
	if err != nil {
	...
	var storage orders_app.Storage
	{
		sqlstor := orders_sqlstorage.New()
	...
	serverHttp := orders_internalhttp.NewServer(logg, storage, endpointHttp)
	...
	logg.Info("orders_service is running...")
